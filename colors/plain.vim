...
call s:h("TabLine",       {"fg": s:norm, "bg": s:bg, "gui": "underline", "cterm": "underline"})
call s:h("TabLineSel",    {"fg": s:norm, "bg": s:lighter_gray, "gui": "underline,bold", "cterm": "underline,bold"})
call s:h("TabLineFill",   {"fg": s:norm, "bg": s:bg, "gui": "underline", "cterm": "underline"})
